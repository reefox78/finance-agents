...
{
  "AAPL": [
    {"ts": "2026-04-05T14:32:00", "score": 0.35, "decision": "ACHETER"},
    ...
  ],
  "BTC-USD": [...]
}
...
def enregistrer_score(ticker: str, score: float, decision: str) -> None:
    ...
    # On ne garde que les MAX_ENTRIES derniers points
...
def lire_historique(ticker: str) -> list[dict]:
    ...
    Chaque entrée : {"ts": str, "score": float, "decision": str}
    """
