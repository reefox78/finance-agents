...
start "Backend FastAPI :8000" cmd /k "cd /d %~dp0 && call venv\Scripts\activate && pip install -r backend/requirements-backend.txt -q && uvicorn backend.main:app --reload --app-dir ."
